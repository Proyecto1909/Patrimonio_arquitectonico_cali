...
# Fondo de la aplicación desde Google Drive
...
# Diccionario de clases (solo descripción)
clases_info = {
    ...
    try:
        ...
        if resultado['predictions']:
            ...
            if clase_detectada in clases_info:
                ...
                # Tarjeta decorativa con descripción
                st.markdown(
                    f"""
                    <div style='
                    ...
                    '>
                        <h4 style='text-align: center; color: #333; font-weight: bold;'>Reseña Historica</h4>
                ...
                st.markdown(
                    "<p style='text-align: center; color: red;'>La clase detectada no está registrada en el diccionario.</p>",
                    unsafe_allow_html=True
                )
        else:
            st.markdown(
                "<p style='text-align: center; font-size: 24px;'>No se detectaron objetos.</p>",
                unsafe_allow_html=True
            )
